...
class AmbientBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // The two σ90 blobs are static, so isolate this whole backdrop on its own
    // layer: without a RepaintBoundary the heavy blur re-rasterizes whenever a
    // sibling in the shell Stack (the scrolling content) repaints. With it, the
    // blur is rasterized once and the cached layer is reused every frame.
