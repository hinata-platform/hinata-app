...
/// Who of the reader's colleagues is away today (HIN-118): at most five names,
/// then how many more. Only while the operator switched the team calendar on —
/// the card is not built otherwise, so nothing is asked.
///
